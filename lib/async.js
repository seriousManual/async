...
(function () {
        ...
        _forEach(keys, function (k) {
            ...
            var ready = function () {
                return _reduce(requires, function (a, x) {
                    return (a && Object.prototype.hasOwnProperty.call(results,x));
                }, true);
            };
            if (ready()) {
    ...
    async.eventedQueue = function( autoRelock ) {
    ...
    async.coordinator = function(constraints, callback) {
