...
exports['eventedQueue relock'] = function( test ){
...
exports['eventedQueue relock retrigger'] = function( test ){
...
exports['eventedQueue autorelock'] = function( test ){
    ...
    var  callOrder      = []
        ,numberCalled   = 0
        ,eq             = async.eventedQueue( true ); //<--- setting default behaviour to relock after trigger
